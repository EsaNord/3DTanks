...
{
    public class DefeatUIItem : MonoBehaviour
    {
        [SerializeField]
        ...
        private const string InfoLostKey = "lost";
        ...
        /// <summary>
        /// Sets text in defeat ui's items.
        /// </summary>
        private void SetText()
        {
            string infoTranslation = L10n.CurrentLanguage.GetTranslation(InfoLostKey);
